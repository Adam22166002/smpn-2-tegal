<div id="onlineModal" class="modal-container fixed inset-0 bg-black bg-opacity-50 hidden z-50">
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="bg-white rounded-xl shadow-lg w-full max-w-md">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-bold">Form Appointment Online</h3>
                    <button onclick="closeModal('onlineModal')" class="text-gray-500 hover:text-gray-700">
                ...
                <form action="{{ route('bk-appointment.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-gray-700 mb-2">Platform yang Disukai</label>
                        <select name="platform" class="w-full border rounded-lg px-3 py-2">
                    ...
                    <div class="flex justify-end space-x-3">
                        <button type="button" onclick="closeModal('onlineModal')"
