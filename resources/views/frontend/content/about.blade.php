        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                <h1 class="display-4 fw-bold mb-4" data-wow-duration="1s" data-wow-delay=".2s">
                    ...
                    Web Resmi <span class="about-title wow fadeIn">{{$about->title}}</span>
                </h1>
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <a href="{{route('visimisi.sekolah')}}" class="btn btn-white border border-primary text-primary btn-lg px-4 rounded-pill">
