...
<div class="hero-sejarah position-relative d-flex align-items-center justify-content-center" 
        ...
        <div class="container text-header-mobile text-start text-black">
            <h1 class="display-4 header-mobile text-primary poppins-semibold font-weight-bold mb-3" style="margin-top: 5rem;">Informasi Akademik</h1>
