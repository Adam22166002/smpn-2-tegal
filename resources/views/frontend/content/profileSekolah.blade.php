                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                <tbody>
                                    <tr>
                                        <td class="font-weight-bold text-black ps-4"style="font-weight:bold;" style="width: 40%;">NPSN</td>
                                        <td>20329833</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold text-black ps-4"style="font-weight:bold;">Tingkatan</td>
                                        <td>Sekolah Menengah Pertama</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold text-black ps-4"style="font-weight:bold;">Kepala Sekolah</td>
                                        <td>Ries Murdiani</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold text-black ps-4"style="font-weight:bold;">Operator</td>
                                        <td>Efta Shufiyati</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold text-black ps-4"style="font-weight:bold;">Akreditasi</td>
                                        <td><span class="badge badge-success">A</span></td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold text-black ps-4"style="font-weight:bold;">Kurikulum</td>
                                        <td>SMP 2013</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold text-black ps-4"style="font-weight:bold;">Jam Belajar</td>
                                        <td>Pagi/6 hari</td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold text-black ps-4"style="font-weight:bold;">Luas Tanah</td>
                                        <td>7,600 m²</td>
                                    </tr>
                                </tbody>
                            </table>
