<div class="news-event-area">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 event-inner-area">
                ...
                <<<<<<< HEAD <div
                    ...
                    <div class="container">
                        <div class="row">
                            <<<<<<< HEAD=======@foreach ($event as $events) <div
                                class="event-terbaru col-lg-6 col-md-6 col-sm-12">
                                <div class="single-item">
                                    <div class="item-img">
                                        <a href="{{route('detail.event',$events->slug)}}">
                                            <img src="{{asset('storage/images/event/' .$events->thumbnail)}}"
                                                alt="event" class="img-responsive">
                                        </a>
                                    </div>
    ...
    <div class="col-xs-12 event-inner-area" style="margin-bottom: 5rem;">
        <div class="d-flex justify-content-between align-items-center mb-4"
            ...
            <div>
                <a href="{{ route('event') }}" class="text-primary">Lihat Semua Event <i
