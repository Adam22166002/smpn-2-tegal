        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action=" {{route('backend-pengguna-murid.update', $murid->id)}} " method="post"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status"
                                            ...
                                            <option value="Tidak Aktif" {{$murid->status == 'Tidak Aktif' ? 'selected' :
                                                ''}} >Tidak Aktif</option>
                                        </select>
                                        @error('status')
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control @error('role') is-invalid @enderror">
                                            <option value="">-- Pilih --</option>
                                            <option value="Murid" {{$murid->role == 'Murid' ? 'selected' : ''}} >Murid
                                            </option>
                                            <option value="Guest" {{$murid->role == 'Guest' ? 'selected' : ''}} >Guest
                                            </option>
                                        </select>
                                        @error('role')
                                        <div class="invalid-feedback">
