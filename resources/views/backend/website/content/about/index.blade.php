                                    ...
                                    <table class="dt-responsive table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{$key+1}} </td>
                                                <td>
                                                    <img src="{{asset('storage/images/about/' .$abouts->image)}}"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" style="font-size: 10px">Disarankan
                                                        background berwarna putih atau .png.</span>
                                                    @error('image')
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="basicInput">Judul About</label> <span
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="basicInput">Deskripsi About</label> <span
                                                        class="text-danger">*</span>
                                                    <textarea name="desc"
