                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="is_active"
                                            ...
                                            <option value="0" {{$jurusan->is_active == 0 ? 'selected' : ''}} >Aktif
                                            </option>
                                            <option value="1" {{$jurusan->is_active == 1 ? 'selected' : ''}}>Tidak Aktif
                                            </option>
                                        </select>
                                        @error('is_active')
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="content"
                                            ...
                                            rows="10"> {{$jurusan->dataJurusan->content}} </textarea>
                                        @error('content')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
