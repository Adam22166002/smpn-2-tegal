                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                    ...
                                    <div class="media">
                                        <a href="javascript:void(0);" class="mr-25">
                                            ...
                                            <img class="round" src="{{asset('Assets/Backend/images/user.png')}}"
                                                alt="avatar" height="80" width="80">
                                            @else
                                            <img src="{{asset('storage/images/profile/' .$profile->foto_profile)}}"
                                    ...
                                    <form class="validate-form mt-2"
                                        action=" {{route('profile-settings.update', $profile->id)}}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mt-75">
                                                <div class="alert alert-warning mb-50" role="alert">
                                                    <h4 class="alert-heading">Email belum dikonfirmasi. Silakan periksa
                                                        kotak masuk.</h4>
                                                    <div class="alert-body">
                                                        <a href="javascript: void(0);" class="alert-link">Kirim ulang
                                                            konfirmasi</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="account-vertical-password" role="tabpanel"
                                    ...
                                    <form class="validate-form"
                                        action=" {{route('profile.change-password', $profile->id)}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        {{-- <div class="row">
                                            <div class="col-12 col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label for="account-retype-new-password">Masukan Ulang Password
                                                        Baru</label>
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="password"
