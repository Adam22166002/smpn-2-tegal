...
<link rel="stylesheet" type="text/css"
    href="{{asset('Assets/Backend/vendors/css/pickers/flatpickr/flatpickr.min.css')}}">
<!-- END: Vendor CSS-->
...
<link rel="stylesheet" type="text/css"
    href="{{asset('Assets/Backend/vendors/css/tables/datatable/dataTables.bootstrap4.min.css')}}">
<link rel="stylesheet" type="text/css"
    href="{{asset('Assets/Backend/vendors/css/tables/datatable/responsive.bootstrap4.min.css')}}">
<link rel="stylesheet" type="text/css"
    href="{{asset('Assets/Backend/vendors/css/tables/datatable/buttons.bootstrap4.min.css')}}">
